...
Page({
  ...
  toEditUserInfo: function(obj) {
    ...
    if (formData['school'] != userInfo['school'] && formData['school'].length < 4) {
      _this.showError('请正确输入学校名称');
      return false;
    }
        ...
        if (ret.code == 200) {
          ...
          wx.showToast({
            ...
            success: function() {
              ...
              utils.toSendTemplate('2Qj2p7p-ZRWTx0p8Br8zwNePNN2vseZIOeq61j5G3vQ', formId, [updateFieldCNName, wechatNickName + '于' + utils.getNowDate() + '成功修改资料', tips], '/pages/user/index');
