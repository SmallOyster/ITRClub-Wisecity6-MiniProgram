              ...
              if (ret.code == 200) {
                ...
                _this.setData({
                  ...
                  SSONickName: ''
								...
								utils.toSendTemplate("0TeRDz8_vok_4vZPRZWQcCtPdouulRKA2Wkmgm-Yjjc", formId, [userInfo['userName'], userInfo['nickName'], utils.getNowDate(), '解绑成功！期待您再次使用我们的服务！']);
